...
namespace UberFrba.ABM_de_Rol
{
    public partial class ListadoModif : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                string query = "select F.funcionalidad_id ID,F.funcionalidad_descripcion Denominacion from PUSH-IT-TO-THE-LIMIT.Funcionalidad F, PUSH-IT-TO-THE-LIMIT.RolporFunciones FR where F.funcionalidad_id = FR.funcionalidad_id and FR.rol_id = " + dataGridView1.CurrentRow.Cells[2].Value.ToString(); ;
