...
namespace UberFrba.ABM_de_Rol
{
    public partial class Alta : Form
    {
        ...
        {
            string query = "select distinct F.funcionalidad_id ID,F.funcionalidad_descripcion Denominacion from PUSH-IT-TO-THE-LIMIT.Funcionalidad F" ;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            decimal id = 0;
            string insert = "EXEC PUSH-IT-TO-THE-LIMIT.InsertarRol '" + textBox1.Text + "',";
            ...
            string comand = "EXEC PUSH-IT-TO-THE-LIMIT.InsertarFuncXRol " + id.ToString() + ",";
