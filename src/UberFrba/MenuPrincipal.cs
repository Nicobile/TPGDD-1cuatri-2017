...
namespace MercadoEnvio
{
    public partial class MenuPrincipal : Form
    {
        ...
        private void MenuPrincipal_Load(object sender, EventArgs e)
        {
            ...
            String funcionalidadesUsuario = "select f.funcionalidad_descripcion from PUSH-IT-TO-THE-LIMIT.ROL r, PUSH-IT-TO-THE-LIMIT.RolporFunciones fr, PUSH-IT-TO-THE-LIMIT.Funcionalidad f where r.rol_id = fr.rol_id and f.funcionalida_id = fr.funcionalidad_id and r.rol_nombre = @rol";
